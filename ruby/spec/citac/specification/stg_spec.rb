...
require_relative '../../../lib/citac/specification/stg'

describe Citac::ConfigurationSpecification do
  describe '#to_stg' do
    it 'should generate simple stg' do
      specification = Citac::ConfigurationSpecification.from_confspec ['3']
    ...
    it 'should generate advanced stg' do
      specification = Citac::ConfigurationSpecification.from_confspec ['5']
      specification.add_dep 2, 3
