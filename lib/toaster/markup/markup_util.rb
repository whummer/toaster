...
<OTA_UpdateRQ>
  ...
  <Subtree Operation="error">
    ...
    def self.hash_diff_as_prop_changes(h1, h2)
      ...
      hashdiffs.each do |d|
        c = StatePropertyChange.new
        c.action = d[0] == "-" ? StatePropertyChange::ACTION_DELETE :
                   d[0] == "+" ? StatePropertyChange::ACTION_INSERT :
                   d[0] == "~" ? StatePropertyChange::ACTION_MODIFY : nil
        c.property = d[1]
        ...
        if c.action == StatePropertyChange::ACTION_INSERT && c.value.nil?
